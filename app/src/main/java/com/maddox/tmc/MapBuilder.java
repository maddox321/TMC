...
//    private static Logger logger = Logger.getLogger(MapBuilder.class.getName());
    ...
    public void parseOsmFile(String filename){
        ...
        try {
            ...
            parser.setContentHandler((org.xml.sax.ContentHandler) contentHandler);
    ...
    public void mergeTiles() {
        ...
        do{
            ...
            Collections.sort(sortedTiles, (java.util.Comparator<? super String>) new TileComparator());
  ...
  //      logger.info("Merging "+subtile+" with " + basetile);
    ...
    public void writeTiles(String tilesDir) throws IOException {
        ...
        while(it.hasNext()){
            ...
            Collections.sort(mapItems, (java.util.Comparator<? super MapItem>) new ItemComparator());
